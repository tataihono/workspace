# North Campus - Component Breakdown
...
The campus hero includes a stats overlay showing establishment year, service time, address, and a directions link. This is a variant of the standard hero-banner component, with the stats overlay being specific to campus pages.

## Payload Collections Used

- **campuses** (synced from Rock) - primary data source for campus details
