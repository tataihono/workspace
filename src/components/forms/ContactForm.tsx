...
export function ContactForm() {
  ...
  if (status === 'success') {
    return (
      <div className="rounded-md border border-green-200 bg-green-50 p-6 text-center">
        <p className="text-lg font-semibold text-green-800">Thank you for reaching out.</p>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        <label htmlFor="contact-name" className="mb-1.5 block text-sm font-medium text-brand-black">
      ...
      <div>
        <label htmlFor="contact-email" className="mb-1.5 block text-sm font-medium text-brand-black">
      ...
      <div>
        <label htmlFor="contact-campus" className="mb-1.5 block text-sm font-medium text-brand-black">
          Campus
        </label>
        <select id="contact-campus" name="campus" className={inputStyles}>
      ...
      <div>
        <label htmlFor="contact-message" className="mb-1.5 block text-sm font-medium text-brand-black">
          Message <span className="text-rich-red">*</span>
        </label>
        <textarea
          id="contact-message"
          name="message"
